...
class UScriptStruct* FHitScanTrace::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HitScanTrace.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHitScanTrace, Z_Construct_UPackage__Script_CoopGame(), TEXT("HitScanTrace"));
	}
...
template<> COOPGAME_API UScriptStruct* StaticStruct<FHitScanTrace>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASWeapon_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASWeapon_Fire, "Fire" }, // 279455568
		{ &Z_Construct_UFunction_ASWeapon_OnRep_HitScanTrace, "OnRep_HitScanTrace" }, // 114907338
		{ &Z_Construct_UFunction_ASWeapon_ServerFire, "ServerFire" }, // 2748718080
		{ &Z_Construct_UFunction_ASWeapon_StartFire, "StartFire" }, // 3368538430
		{ &Z_Construct_UFunction_ASWeapon_StopFire, "StopFire" }, // 680314282
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_Statics::ScriptStructInfo[] = {
		{ FHitScanTrace::StaticStruct, Z_Construct_UScriptStruct_FHitScanTrace_Statics::NewStructOps, TEXT("HitScanTrace"), &Z_Registration_Info_UScriptStruct_HitScanTrace, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHitScanTrace), 3272668225U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASWeapon, ASWeapon::StaticClass, TEXT("ASWeapon"), &Z_Registration_Info_UClass_ASWeapon, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASWeapon), 473554595U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_1439934878(TEXT("/Script/CoopGame"),
		Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_CoopGame_Source_CoopGame_Public_SWeapon_h_Statics::ScriptStructInfo),
		nullptr, 0);
